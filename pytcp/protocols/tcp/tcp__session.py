...
class TcpSession:
    ...
    def _phase1_compose_ecn_flags(
        ...
        *,
        ...
        # encoding.
            ...
            ace = self._accecn.next_ace_field()
    ...
    def _phase2_build_accecn_counters(
        ...
        *,
        ...
        if not self._accecn.enabled or flag_rst or (flag_syn and not flag_ack):
            return None, None
        return self._accecn.next_emit_counters()
    ...
    def _phase3_build_fastopen_cookie(self, *, flag_syn: bool, flag_ack: bool) -> bytes | None:
        ...
        Returns:
          - 'self._fastopen_cookie_to_emit' on a passive-open
        ...
        if flag_syn and flag_ack and self._fastopen_cookie_to_emit is not None:
            return self._fastopen_cookie_to_emit
