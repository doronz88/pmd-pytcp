...
class TxStatus(IntEnum):
    ...
    DROPED__ETHERNET__DST_ARP_CACHE_MISS = auto()
    DROPED__ETHERNET__DST_ND_CACHE_MISS = auto()
    DROPED__ETHERNET__DST_NO_GATEWAY_IP4 = auto()
    DROPED__ETHERNET__DST_NO_GATEWAY_IP6 = auto()
    DROPED__ETHERNET__DST_GATEWAY_ARP_CACHE_MISS = auto()
    DROPED__ETHERNET__DST_GATEWAY_ND_CACHE_MISS = auto()
