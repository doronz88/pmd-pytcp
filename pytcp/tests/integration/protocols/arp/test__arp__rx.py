...
preserved at 'pytcp/tests/integration/test__packet_handler__arp__rx.py'
...
@parameterized_class(
    [
        ...
        # ---------------------------------------------------------
        # Conflict-defense paths (Request and Reply)
        # ---------------------------------------------------------
        {
            "_description": "Request with SPA == our IP — defend with gratuitous ARP",
            "_frames_rx": [
                ArpTestCase._build_arp_frame(
                    ethernet_dst=_BCAST_MAC,
                    ethernet_src=_PEER_MAC,
        ...
        {
            "_description": "Reply with SPA == our IP — defend with gratuitous ARP",
            "_frames_rx": [
                ArpTestCase._build_arp_frame(
                    ethernet_dst=_STACK_MAC,
                    ethernet_src=_PEER_MAC,
        ...
        {
            "_description": "Gratuitous Request announcing our candidate IP — probe conflict, no learn",
            "_frames_rx": [
                ArpTestCase._build_arp_frame(
                    ethernet_dst=_BCAST_MAC,
                    ethernet_src=_PEER_MAC,
                    arp_oper=ArpOperation.REQUEST,
                    arp_sha=_PEER_MAC,
                    arp_spa=_CANDIDATE_IP,
                    arp_tpa=_CANDIDATE_IP,
                ),
            ],
            "_expected__frames_tx": [],
            "_expected__packet_stats_rx": PacketStatsRx(
        ...
        {
            "_description": "Gratuitous Reply announcing our candidate IP — probe conflict, no learn",
            "_frames_rx": [
                ArpTestCase._build_arp_frame(
                    ethernet_dst=_BCAST_MAC,
                    ethernet_src=_PEER_MAC,
        ...
        {
            "_description": "Reply to our probe (SPA = candidate, TPA = unspecified) — probe conflict",
            "_frames_rx": [
                ArpTestCase._build_arp_frame(
                    ethernet_dst=_STACK_MAC,
                    ethernet_src=_PEER_MAC,
