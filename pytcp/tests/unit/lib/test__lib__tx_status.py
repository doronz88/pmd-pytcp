...
_EXPECTED_MEMBERS: tuple[str, ...] = (
    ...
    "DROPED__ETHERNET__DST_ARP_CACHE_MISS",
    "DROPED__ETHERNET__DST_ND_CACHE_MISS",
    "DROPED__ETHERNET__DST_NO_GATEWAY_IP4",
    "DROPED__ETHERNET__DST_NO_GATEWAY_IP6",
    "DROPED__ETHERNET__DST_GATEWAY_ARP_CACHE_MISS",
    "DROPED__ETHERNET__DST_GATEWAY_ND_CACHE_MISS",
    "DROPED__ETHERNET__DST_RESOLUTION_FAIL",
    "PASSED__ETHERNET_802_3__TO_TX_RING",
    "DROPED__ETHERNET_802_3__DST_RESOLUTION_FAIL",
    "DROPED__ARP__NO_PROTOCOL_SUPPORT",
    "PASSED__IP4__TO_TX_RING",
    "DROPED__IP4__NO_PROTOCOL_SUPPORT",
    "DROPED__IP4__SRC_NOT_OWNED",
    "DROPED__IP4__SRC_MULTICAST",
    "DROPED__IP4__SRC_LIMITED_BROADCAST",
    "DROPED__IP4__SRC_NETWORK_BROADCAST",
    "DROPED__IP4__SRC_UNSPECIFIED",
    "DROPED__IP4__DST_UNSPECIFIED",
    "DROPED__IP4__UNKNOWN",
    "PASSED__IP6__TO_TX_RING",
    "DROPED__IP6__NO_PROTOCOL_SUPPORT",
    "DROPED__IP6__SRC_NOT_OWNED",
    "DROPED__IP6__SRC_MULTICAST",
    "DROPED__IP6__SRC_LIMITED_BROADCAST",
    "DROPED__IP6__SRC_NETWORK_BROADCAST",
    "DROPED__IP6__SRC_UNSPECIFIED",
    "DROPED__IP6__DST_UNSPECIFIED",
    "DROPED__IP6__UNKNOWN",
    "DROPED__IP6__EXT_FRAG_UNKNOWN",
    "DROPED__UDP__UNKNOWN",
    "DROPED__TCP__UNKNOWN",
    "DROPED__ICMP4__UNKNOWN",
    "DROPED__ICMP6__UNKNOWN",
)
...
@parameterized_class(
    [
        ...
        {
            "_description": "Middle member: DROPED__IP4__UNKNOWN.",
            "_member": TxStatus.DROPED__IP4__UNKNOWN,
            "_results": {
                "name": "DROPED__IP4__UNKNOWN",
                "value": 20,
                "__str__": "DROPED__IP4__UNKNOWN",
            },
        },
        {
            "_description": "Last member: DROPED__ICMP6__UNKNOWN.",
            "_member": TxStatus.DROPED__ICMP6__UNKNOWN,
            "_results": {
                "name": "DROPED__ICMP6__UNKNOWN",
                "value": 34,
                "__str__": "DROPED__ICMP6__UNKNOWN",
            },
        },
        {
            "_description": "Nested Ethernet drop: DROPED__ETHERNET__DST_GATEWAY_ARP_CACHE_MISS.",
            "_member": TxStatus.DROPED__ETHERNET__DST_GATEWAY_ARP_CACHE_MISS,
            "_results": {
                "name": "DROPED__ETHERNET__DST_GATEWAY_ARP_CACHE_MISS",
                "value": 6,
                "__str__": "DROPED__ETHERNET__DST_GATEWAY_ARP_CACHE_MISS",
            },
        },
        {
            "_description": "IPv6 frag drop: DROPED__IP6__EXT_FRAG_UNKNOWN.",
            "_member": TxStatus.DROPED__IP6__EXT_FRAG_UNKNOWN,
            "_results": {
                "name": "DROPED__IP6__EXT_FRAG_UNKNOWN",
                "value": 30,
                "__str__": "DROPED__IP6__EXT_FRAG_UNKNOWN",
            },
        },
    ]
)
