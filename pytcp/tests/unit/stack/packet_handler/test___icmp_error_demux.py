...
'pytcp/stack/packet_handler/_icmp_error_demux.py'. Pins the IP+L4
...
pytcp/tests/unit/stack/packet_handler/test___icmp_error_demux.py
...
from pytcp.stack.packet_handler._icmp_error_demux import (
    EmbeddedL4,
    parse_embedded_l4,
)
