...
pytcp/tests/unit/stack/packet_handler/test__packet_handler__ip6_frag__tx__rfc6980.py
...
from pytcp.stack.packet_handler.packet_handler__ip6_frag__tx import is_ndp_message
