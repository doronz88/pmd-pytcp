...
pytcp/tests/unit/stack/test__stack__timer.py
...
from pytcp.stack.timer import Timer, TimerTask
...
class TestTimerRegisterTimer(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self._log_patch = patch("pytcp.stack.timer.log")
...
class TestTimerSubsystemLoop(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self._subsystem_log_patch = patch("pytcp.lib.subsystem.log")
        self._subsystem_log_patch.start()
        self._sleep_patch = patch("pytcp.stack.timer.time.sleep")
