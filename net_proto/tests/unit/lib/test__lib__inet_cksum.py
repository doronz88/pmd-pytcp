...
net_proto/tests/unit/lib/test__lib__internet_checksum.py
...
from net_proto import inet_cksum
...
@parameterized_class(
    [
        ...
        },
        {
            ...
            "_args": [
                b"\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f" * 80,
            ],
            "_kwargs": {
                "init": 0x03DF,
            },
