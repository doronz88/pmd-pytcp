...
class TestIcmp4MessageEchoReplyAssemblerAsserts(TestCase):
    """
...
class TestIcmp4MessageEchoReplyParserAsserts(TestCase):
    """
    The ICMPv4 Echo Reply message parser argument constructor assert tests.
    """

    def test__icmp4__message__echo_reply__wrong_type(self) -> None:
        """
