...
net_proto/tests/unit/protocols/icmp4/test__icmp4__echo_request__parser__integrity_checks.py
...
class TestIcmp4EchoRequestParserIntegrityChecks(TestCasePacketRxIp4):
    """
    ...
    def test__icmp4__echo_request__parser__from_bytes(self) -> None:
        """
