...
net_proto/tests/unit/protocols/ip4/test__ip4__parser__packet.py
    ...
    [
        {
            ...
            "_args": [
                b"\x45\xff\x00\x14\xff\xff\x40\x00\xff\xff\xd9\x23\x0a\x14\x1e\x28" b"\x32\x3c\x46\x50",
            ],
            "_kwargs": {},
            "_results": {
                "header": Ip4Header(
        ...
        },
        {
            ...
            "_results": {
                ...
                "header_bytes": (
                    b"\x45\x46\x00\x24\x30\x39\x40\x00\xff\xff\x3a\x48\x01\x02\x03\x04" b"\x05\x06\x07\x08"
                ),
        ...
        },
        {
            ...
            "_results": {
                ...
                "payload": b"X" * 65475,
                "header_bytes": (
                    b"\x4f\x20\xff\xff\x52\xdc\x00\x00\x40\xff\x02\xea\x01\x01\x01\x01" b"\x02\x02\x02\x02"
                ),
        ...
        },
        {
            ...
            "_results": {
                ...
                "payload": b"0123456789ABCDEF",
                "header_bytes": (
                    b"\x45\x29\x00\x24\xd4\x31\x0f\xa1\x80\xff\x41\xd0\x04\x03\x02\x01" b"\x08\x07\x06\x05"
                ),
                "payload_bytes": (b"\x30\x31\x32\x33\x34\x35\x36\x37\x38\x39\x41\x42\x43\x44\x45\x46"),
                "packet_bytes": (
                    b"\x45\x29\x00\x24\xd4\x31\x0f\xa1\x80\xff\x41\xd0\x04\x03\x02\x01"
        ...
        },
        {
            ...
            "_args": [
                b"\x45\x46\x05\xce\x30\x39\x20\x00\xff\xff\x54\x9e\x01\x02\x03\x04" b"\x05\x06\x07\x08" + b"X" * 1466,
            ],
            "_kwargs": {},
            "_results": {
                "header": Ip4Header(
                ...
                "payload": b"X" * 1466,
                "header_bytes": (
                    b"\x45\x46\x05\xce\x30\x39\x20\x00\xff\xff\x54\x9e\x01\x02\x03\x04" b"\x05\x06\x07\x08"
                ),
