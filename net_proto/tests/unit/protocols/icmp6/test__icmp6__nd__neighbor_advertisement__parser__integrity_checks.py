...
net_proto/tests/unit/protocols/icmp6/test__icmp6__nd__neighbor_addvertisement__parser__integrity_checks.py
...
class TestIcmp6NdNeighborAdvertisementParserIntegrityChecks(
    TestCasePacketRxIp6
):
    """
