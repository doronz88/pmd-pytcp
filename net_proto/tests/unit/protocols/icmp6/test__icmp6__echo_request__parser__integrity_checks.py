...
net_proto/tests/unit/protocols/icmp6/test__icmp6__echo_request__parser__integrity_checks.py
...
@parameterized_class(
    [
        ...
        },
        {
            ...
            "_args": [b"\x80\x00\xfb\x94\x30\x39\xd4"],
            "_mocked_values": {
                "ip6__dlen": 8,
            },
            "_results": {
        ...
        },
        {
            ...
            "_args": [b"\x80\x00\x00\x00\x30\x39\xd4\x31"],
            "_mocked_values": {},
            "_results": {
