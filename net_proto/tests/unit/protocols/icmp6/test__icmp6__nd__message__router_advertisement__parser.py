...
@parameterized_class(
    [
        ...
        },
        {
            ...
            "_args": [
                b"\x86\x00\xcd\x0c\x40\x00\x00\x7b\x00\x00\x01\xc8\x00\x00\x03\x15" b"\x01\x01\x00\x11\x22\x33\x44\x55"
            ],
            "_mocked_values": {
                "ip6__hop": 255,
                "ip6__src": Ip6Address("fe80::1"),
...
class TestIcmp6NdMessageRouterAdvertisementParser(TestCasePacketRxIp6):
    """
