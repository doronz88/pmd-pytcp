...
from pmd_pytcp.runtime.fib import Route, RouteProtocol, RouteScope
...
from pmd_pytcp.socket.packet__socket_table import PacketSocketTable
...
if TYPE_CHECKING:
    from pmd_net_addr import Ip4IfAddr, Ip4Network, Ip6IfAddr, Ip6Network
    from pmd_pytcp.lib.plpmtud import PmtuSearch
    from pmd_pytcp.protocols.ip4.link_local.link_local__client import Ip4LinkLocal
...
# 'pmd_pytcp.protocols.tcp.tcp__iss.compute_iss' reads this when TcpSession picks
...
# the per-(src, dst) flow-label hash. 'pmd_pytcp.protocols.ip6.ip6__flow_label.compute_ip6_flow_label'
...
# by 'pmd_pytcp.socket.socket__bind_helpers.pick_local_port_for' to compute
...
# protocol code at 'pmd_pytcp/protocols/arp/arp__constants.py'.
# Importers should refer to that module directly rather than
# reaching through 'pmd_pytcp.stack'.

# ICMPv6 ND cache aging timers moved to the generic NUD
# framework at 'pmd_pytcp/lib/neighbor__constants.py' alongside
...
# Operators tune these via 'pmd_pytcp.stack.sysctl["neighbor.X"]'
...
# 'pmd_pytcp.stack.sysctl["<dotted.key>"] = N'. Per the framework's
...
# the rationale.
from pmd_pytcp.stack.sysctl import get as _sysctl_get  # noqa: E402
from pmd_pytcp.stack.sysctl import is_int_in_range as _sysctl_is_int_in_range  # noqa: E402
from pmd_pytcp.stack.sysctl import is_positive_int as _sysctl_is_positive_int  # noqa: E402
from pmd_pytcp.stack.sysctl import register as _sysctl_register  # noqa: E402
from pmd_pytcp.stack.sysctl import register_finalize_validator as _sysctl_register_finalize_validator  # noqa: E402
...
# Lifecycle entry points live in pmd_pytcp/stack/lifecycle.py per
# Phase 2 of docs/refactor/pytcp_directory_restructure.md; re-
# exported here so 'pmd_pytcp.stack.{init,start,stop,mock__init,
...
from pmd_pytcp.stack.lifecycle import (  # noqa: E402, F401
    add_interface,
    init,
    mock__init,
    remove_interface,
