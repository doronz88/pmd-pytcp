...
values the control APIs traffic in — pmd_net_addr addresses / networks /
...
and is therefore pmd_pytcp-resident, not part of the extraction-ready codec
core (see docs/refactor/kernel_userspace_separation.md §2).

pmd_pytcp/ipc/ipc__values.py
...
# pmd_net_addr value types — encoded as their canonical str() and rebuilt by
