...
timing knobs registered as 'pmd_pytcp.stack.sysctl' sysctls so the
...
pmd_pytcp/protocols/ip4/link_local/link_local__constants.py
...
# via 'pmd_pytcp.stack.sysctl["ip4_link_local.X"] = N'.
from pmd_pytcp.stack.sysctl import is_non_negative_int, is_positive_int, register  # noqa: E402
