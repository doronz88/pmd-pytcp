...
# 'pmd_pytcp/lib/neighbor__constants.py'. The ARP cache is now a
...
# 'pmd_pytcp.stack.sysctl["neighbor.reachable_time"]' or the
...
# or at runtime via 'pmd_pytcp.stack.sysctl["arp...."] = N'). The
...
from pmd_pytcp.stack.sysctl import get, is_positive_int, register, register_finalize_validator  # noqa: E402
