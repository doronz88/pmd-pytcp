...
('pmd_pytcp/socket/udp__metadata.py', 'pmd_pytcp/socket/raw__metadata.py'):
...
so the file lives next to the FSM under 'pmd_pytcp/protocols/tcp/'.

pmd_pytcp/protocols/tcp/tcp__icmp_metadata.py
