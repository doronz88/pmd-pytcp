...
pmd_pytcp/protocols/tcp/session/tcp__session.py
...
from pmd_pytcp.protocols.tcp.fsm import dispatch_packet as tcp_fsm_dispatch_packet
from pmd_pytcp.protocols.tcp.fsm import dispatch_syscall as tcp_fsm_dispatch_syscall
from pmd_pytcp.protocols.tcp.fsm import dispatch_timer as tcp_fsm_dispatch_timer
...
from pmd_pytcp.protocols.tcp.session.tcp__session__timers import TcpTimerService
from pmd_pytcp.protocols.tcp.session.tcp__session__tx import TcpTxEngine
from pmd_pytcp.protocols.tcp.session.tcp__session__validate import TcpSegmentValidator
from pmd_pytcp.protocols.tcp.state.tcp__state__accecn import AccEcnState
from pmd_pytcp.protocols.tcp.state.tcp__state__advertise import AdvertiseState
from pmd_pytcp.protocols.tcp.state.tcp__state__cc import CcState
from pmd_pytcp.protocols.tcp.state.tcp__state__ecn_classic import ClassicEcnState
from pmd_pytcp.protocols.tcp.state.tcp__state__fastopen import FastOpenState
from pmd_pytcp.protocols.tcp.state.tcp__state__keepalive import KeepaliveState
from pmd_pytcp.protocols.tcp.state.tcp__state__persist import PersistState
from pmd_pytcp.protocols.tcp.state.tcp__state__rack_tlp import RackTlpState
...
from pmd_pytcp.protocols.tcp.state.tcp__state__shutdown import ShutdownState
from pmd_pytcp.protocols.tcp.state.tcp__state__timestamps import TimestampsState
from pmd_pytcp.protocols.tcp.state.tcp__state__tx_buffer import TxBufferState
from pmd_pytcp.protocols.tcp.state.tcp__state__window import WindowState
from pmd_pytcp.protocols.tcp.tcp__cwnd import compute_ecn_event_ssthresh
from pmd_pytcp.protocols.tcp.tcp__enums import (
    CcMode,
    ConnError,
    FsmState,
    SysCall,
...
from pmd_pytcp.protocols.tcp.tcp__icmp_metadata import IcmpMetadata
...
from pmd_pytcp.protocols.tcp.tcp__rto import RtoState, initial_state
...
class TcpSession:
    ...
    def __init__(
        ...
        *,
        ...
        # 'pmd_pytcp.protocols.tcp.tcp__loss_recovery' for NextSeg / IsLost /
        # Pipe.
        ...
        # 'pmd_pytcp.stack.tcp_stack' (TcpStack). See
    ...
    def shutdown(self, *, how: int) -> None:
        ...
        'how' values (matching pmd_pytcp.socket.SHUT_*):
    ...
    def _apply_pmtu_update(self, *, next_hop_mtu: int, ip_version: int) -> None:
        ...
        if shrunk and any(
            ...
            from pmd_pytcp.protocols.tcp.tcp__rack import INFINITE_TS
