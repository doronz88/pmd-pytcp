...
'pmd_pytcp/protocols/tcp/tcp__fsm__<state>.py'. Three dispatch
...
pmd_pytcp/protocols/tcp/fsm/tcp__fsm.py
...
from pmd_pytcp.protocols.tcp.fsm.tcp__fsm__close_wait import (
...
from pmd_pytcp.protocols.tcp.fsm.tcp__fsm__syn_rcvd import (
    fsm__syn_rcvd__packet,
    fsm__syn_rcvd__syscall,
    fsm__syn_rcvd__timer,
)
from pmd_pytcp.protocols.tcp.fsm.tcp__fsm__syn_sent import (
    fsm__syn_sent__icmp,
...
def fsm__icmp__synchronized(session: TcpSession, metadata: IcmpMetadata) -> None:
    ...
    from pmd_pytcp.protocols.tcp.tcp__icmp_metadata import IcmpCategory
