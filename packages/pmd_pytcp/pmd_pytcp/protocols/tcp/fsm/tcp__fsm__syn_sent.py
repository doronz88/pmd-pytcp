...
pmd_pytcp/protocols/tcp/fsm/tcp__fsm__syn_sent.py
...
from pmd_pytcp.protocols.tcp.tcp__cwnd import initial_window
from pmd_pytcp.protocols.tcp.tcp__enums import ConnError, FsmState, SysCall
from pmd_pytcp.protocols.tcp.tcp__seq import add32, le32, lt32
    ...
    if all({packet_rx_md.tcp__flag_syn, packet_rx_md.tcp__flag_ack}) and not any(
        ...
        if lt32(session._snd_seq.una, packet_rx_md.tcp__ack) and le32(packet_rx_md.tcp__ack, session._snd_seq.nxt):
            ...
            if packet_rx_md.tcp__fastopen_cookie:
                from pmd_pytcp.protocols.tcp.tcp__fastopen import cache_cookie
