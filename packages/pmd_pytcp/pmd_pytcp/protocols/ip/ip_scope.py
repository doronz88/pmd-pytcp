...
('pmd_pytcp/protocols/ip4/ip4__source_selection.py' and
'pmd_pytcp/protocols/ip6/ip6__source_selection.py'). The numeric values are
...
pmd_pytcp/protocols/ip/ip_scope.py
