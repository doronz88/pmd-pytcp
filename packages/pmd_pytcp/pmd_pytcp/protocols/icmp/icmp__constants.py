...
via 'pmd_pytcp.stack.sysctl["icmp.error...."] = N'. Runtime callers MUST
...
pmd_pytcp/protocols/icmp/icmp__constants.py
...
# at runtime via 'pmd_pytcp.stack.sysctl["icmp.error.X"] = N'.
from pmd_pytcp.stack.sysctl import is_positive_int, register  # noqa: E402
