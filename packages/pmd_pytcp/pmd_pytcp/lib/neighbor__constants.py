...
machine at 'pmd_pytcp/lib/neighbor.py'. The NUD timing knobs apply
...
pmd_pytcp/lib/neighbor__constants.py
...
from pmd_pytcp.stack.sysctl import get, is_positive_int, register, register_finalize_validator
