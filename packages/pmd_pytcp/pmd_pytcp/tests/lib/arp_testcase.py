...
pmd_pytcp/tests/lib/arp_testcase.py
...
from pmd_pytcp.protocols.ip4.acd.ip4_acd import AcdResult
...
class ArpTestCase(NetworkTestCase):
    ...
    def setUp(self) -> None:
        ...
        self._arp_cache_monotonic_patch = patch(
            "pmd_pytcp.lib.neighbor.time.monotonic",
        ...
        acd_class = self.enterContext(
            patch("pmd_pytcp.runtime.packet_handler.Ip4Acd", autospec=True),
        )
