...
pmd_pytcp/tests/lib/dhcp4_mock_server.py
...
from pmd_net_proto.protocols.dhcp4.options.dhcp4__option import Dhcp4Option
...
def autospec_dhcp4_socket() -> MagicMock:
    ...
    'pmd_pytcp.socket.socket'. Returned mock is callable (mirroring the
