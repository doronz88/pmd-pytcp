...
"""
The 'pmd_pytcp.stack.neighbor' control-plane API unit tests — the
'ip neighbor' / RTM_NEWNEIGH equivalent backed by the per-interface
ARP / ND caches.

pmd_pytcp/tests/unit/stack/test__stack__neighbor.py
...
from pmd_pytcp.stack.neighbor import NeighborApi, NeighborSnapshot
...
class TestStackNeighborApi(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.enterContext(patch("pmd_pytcp.lib.neighbor.log"))
