...
of 'pmd_pytcp.stack.sysctl' — Phase 0 of the per-interface
...
'pmd_pytcp.stack.sysctl_iface' helper module.

pmd_pytcp/tests/unit/stack/test__stack__sysctl_iface.py
...
from pmd_pytcp.stack import sysctl, sysctl_iface
...
class TestSysctlIfaceHelper(_SysctlIfaceFixtureBase):
    """
    The 'pmd_pytcp.stack.sysctl_iface' helper module surface.
    """
