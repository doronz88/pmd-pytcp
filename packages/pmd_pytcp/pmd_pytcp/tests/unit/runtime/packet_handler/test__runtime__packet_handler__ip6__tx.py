...
pmd_pytcp/tests/unit/runtime/packet_handler/test__runtime__packet_handler__ip6__tx.py
...
from pmd_net_proto import Ip6Assembler, IpProto, RawAssembler
...
from pmd_pytcp.runtime.packet_handler.packet_handler__ip6__tx import (
    Ip6TxHandler,
)
...
class _StubInterface:
    ...
    # 'pmd_pytcp/tests/integration/protocols/icmp6/nd/test__icmp6__nd__ra_parameter_consumers.py'.
