...
pmd_pytcp/tests/unit/runtime/packet_handler/test__runtime__packet_handler__icmp6__tx.py
...
from pmd_pytcp.runtime.packet_handler.packet_handler__icmp6__tx import Icmp6TxHandler
...
class TestPacketHandlerIcmp6TxNeighborAdvertisement(TestCase):
    ...
    def _last_payload(self) -> object:
        ...
        from pmd_net_proto import Icmp6Assembler
    ...
    def test__stack__packet_handler__icmp6__tx__send_na__solicited_with_tlla(self) -> None:
        ...
        from pmd_net_proto import Icmp6NdMessageNeighborAdvertisement
