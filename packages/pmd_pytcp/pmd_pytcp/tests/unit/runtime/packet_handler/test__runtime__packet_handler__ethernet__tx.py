...
pmd_pytcp/tests/unit/runtime/packet_handler/test__runtime__packet_handler__ethernet__tx.py
...
from pmd_pytcp.runtime.packet_handler.packet_handler__ethernet__tx import (
    EthernetTxHandler,
)
