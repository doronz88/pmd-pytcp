...
pmd_pytcp/tests/unit/runtime/packet_handler/test__runtime__packet_handler__arp__rx.py
...
class TestPacketHandlerArpRxRequest(_ArpRxTestBase):
    ...
    def test__stack__packet_handler__arp__rx__unknown_operation_handler_fallthrough_counts_drop(self) -> None:
        ...
        with patch(
            "pmd_pytcp.runtime.packet_handler.packet_handler__arp__rx.ArpParser",
