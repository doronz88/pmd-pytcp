...
pmd_pytcp/tests/unit/runtime/packet_handler/test__runtime__packet_handler__icmp6__rx.py
...
class _StubInterface:
    ...
    # 'pmd_pytcp/tests/integration/protocols/icmp6/nd/test__icmp6__nd__slaac_address_tracking.py'.
    ...
    # 'pmd_pytcp/tests/integration/protocols/icmp6/nd/test__icmp6__nd__ra_parameters.py'.
