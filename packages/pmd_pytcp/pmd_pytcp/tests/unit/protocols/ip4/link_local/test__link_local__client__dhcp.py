...
pmd_pytcp/tests/unit/protocols/ip4/link_local/test__link_local__client__dhcp.py
...
from pmd_pytcp.protocols.ip4.link_local import link_local__constants as ip4ll_const
from pmd_pytcp.protocols.ip4.link_local.link_local__client import (
    Ip4LinkLocal,
    Ip4LinkLocalState,
)
...
class TestIp4LinkLocalDhcpCoordination(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self._mock_time = self.enterContext(
            patch("pmd_pytcp.protocols.ip4.link_local.link_local__client.time.monotonic"),
        )
