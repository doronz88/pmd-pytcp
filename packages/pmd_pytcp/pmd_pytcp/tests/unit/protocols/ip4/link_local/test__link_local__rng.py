...
'pmd_pytcp/protocols/ip4/link_local/link_local__rng.py'.

pmd_pytcp/tests/unit/protocols/ip4/link_local/test__link_local__rng.py
...
from pmd_pytcp.protocols.ip4.link_local.link_local__rng import (
    RANGE_FIRST,
    RANGE_LAST,
    candidate_from_mac,
)
