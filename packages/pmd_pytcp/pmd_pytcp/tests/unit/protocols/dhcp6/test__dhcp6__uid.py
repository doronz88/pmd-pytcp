...
'pmd_pytcp/protocols/dhcp6/dhcp6__uid.py'.

pmd_pytcp/tests/unit/protocols/dhcp6/test__dhcp6__uid.py
...
from pmd_pytcp.protocols.dhcp4.dhcp4__uid import build_duid_ll
from pmd_pytcp.protocols.dhcp6.dhcp6__uid import get_client_duid, get_iaid
