...
Number generator in 'pmd_pytcp/lib/tcp_iss.py'.
...
pmd_pytcp/tests/unit/protocols/tcp/test__tcp__iss.py
...
from pmd_pytcp.protocols.tcp.tcp__iss import ISS_CLOCK_RATE_US, compute_iss
from pmd_pytcp.stack import TCP__ISS_SECRET
