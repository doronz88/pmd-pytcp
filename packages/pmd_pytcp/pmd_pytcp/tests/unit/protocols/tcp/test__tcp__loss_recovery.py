...
'pmd_pytcp.protocols.tcp.tcp__loss_recovery', covering both triggers of IsLost
(count threshold, byte threshold), NextSeg's gap-then-is-lost
gate, and Pipe's in-flight-minus-sacked accounting.

pmd_pytcp/tests/unit/protocols/tcp/test__tcp__loss_recovery.py
...
from pmd_pytcp.protocols.tcp.tcp__loss_recovery import is_lost, next_seg, pipe
