...
'ConnError' enums in 'pmd_pytcp/protocols/tcp/tcp__enums.py', the
'TcpSessionError' exception class in
'pmd_pytcp/protocols/tcp/tcp__errors.py', and the module-level
constants in 'pmd_pytcp/protocols/tcp/tcp__constants.py'.

pmd_pytcp/tests/unit/protocols/tcp/test__tcp__enums.py
...
from pmd_pytcp.protocols.tcp.tcp__constants import (
