...
helpers in 'pmd_pytcp.protocols.tcp.tcp__seq', covering RFC 9293 §3.4 comparison semantics
and the wrap-aware add/sub/in-range utilities.

pmd_pytcp/tests/unit/protocols/tcp/test__tcp__seq.py
...
from pmd_net_proto.lib.int_checks import UINT_32__MAX
from pmd_pytcp.protocols.tcp.tcp__seq import (
    SEQ32__HALF,
    add32,
    ge32,
    gt32,
