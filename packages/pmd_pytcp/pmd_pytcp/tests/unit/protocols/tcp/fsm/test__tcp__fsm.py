...
pmd_pytcp/tests/unit/protocols/tcp/fsm/test__tcp__fsm.py
...
class TestTcpFsmDispatch(_TcpSessionFsmFixture):
    ...
    def test__tcp_session__fsm_dispatches_packet_by_current_state(self) -> None:
        ...
        from pmd_pytcp.protocols.tcp.fsm.tcp__fsm import FSM_PACKET_HANDLERS
    ...
    def test__tcp_session__fsm_dispatches_syscall_by_current_state(self) -> None:
        ...
        from pmd_pytcp.protocols.tcp.fsm.tcp__fsm import FSM_SYSCALL_HANDLERS
    ...
    def test__tcp_session__fsm_dispatches_timer_by_current_state(self) -> None:
        ...
        from pmd_pytcp.protocols.tcp.fsm.tcp__fsm import FSM_TIMER_HANDLERS
...
class TestTcpFsmIcmpDispatch(_TcpSessionFsmFixture):
    ...
    def test__tcp_session__fsm_dispatches_icmp_by_current_state(self) -> None:
        ...
        from pmd_pytcp.protocols.tcp.fsm.tcp__fsm import FSM_ICMP_HANDLERS
        from pmd_pytcp.protocols.tcp.tcp__icmp_metadata import (
            IcmpCategory,
            IcmpMetadata,
        )
    ...
    def test__tcp_session__fsm_icmp_does_not_invoke_packet_or_syscall_or_timer(self) -> None:
        ...
        with (
            patch("pmd_pytcp.protocols.tcp.session.tcp__session.tcp_fsm_dispatch_packet") as mock_packet,
            patch("pmd_pytcp.protocols.tcp.session.tcp__session.tcp_fsm_dispatch_syscall") as mock_syscall,
            patch("pmd_pytcp.protocols.tcp.session.tcp__session.tcp_fsm_dispatch_timer") as mock_timer,
        ):
...
class TestTcpFsmListenHandleIcmp(_TcpSessionFsmFixture):
    ...
    def test__tcp_session__listen_icmp_is_no_op(self) -> None:
        ...
        from pmd_pytcp.protocols.tcp.tcp__enums import ConnError
    ...
    def test__tcp_session__synchronized_icmp_pmtu_updates_snd_mss(self) -> None:
        ...
        for state in self._SYNCHRONIZED_STATES:
            with self.subTest(state=state):
                ...
                with patch(
                    "pmd_pytcp.protocols.tcp.session.tcp__session.stack.pmtu_cache",
                    cache,
                    create=True,
                ):
                    session.tcp_fsm(
...
class TestTcpSessionTransmitPacket(_TcpSessionFsmFixture):
    ...
    def test__tcp_session__transmit_packet_routes_through_packet_handler(self) -> None:
        ...
        with patch(
            "pmd_pytcp.protocols.tcp.session.tcp__session.stack.egress_packet_handler",
