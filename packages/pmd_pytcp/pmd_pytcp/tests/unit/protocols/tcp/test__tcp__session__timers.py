...
pmd_pytcp/tests/unit/protocols/tcp/test__tcp__session__timers.py
...
from pmd_pytcp.protocols.tcp.session.tcp__session import _PUMP
...
class TestTcpSessionTimers(TestCase):
    ...
    def setUp(self) -> None:
        ...
        # 'TcpTimerService' imports 'stack' via 'from pmd_pytcp import
