...
pmd_pytcp/tests/integration/protocols/ip6/test__ip6__harness_smoke.py
...
from pmd_net_proto import Icmp6Assembler, Icmp6MessageEchoRequest, IpProto
...
from pmd_pytcp.tests.lib.ip6_testcase import (
    HOST_A__IP6_ADDRESS,
    HOST_A__MAC_ADDRESS,
    STACK__IP6_HOST,
    STACK__MAC_ADDRESS,
...
class TestIp6HarnessSmoke(Ip6TestCase):
    ...
    def test__ip6__harness__parse_tx_ip6_rejects_non_ip6(self) -> None:
        ...
        bogus = bytes(STACK__MAC_ADDRESS) + bytes(HOST_A__MAC_ADDRESS) + int(EtherType.IP4).to_bytes(2, "big")
