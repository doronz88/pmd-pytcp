...
pmd_pytcp/tests/integration/protocols/ethernet_802_3/test__ethernet_802_3__llc_snap.py
...
class TestEthernet8023LlcSnapDispatch(Ethernet8023TestCase):
    ...
    def test__ethernet_802_3__stp_bpdu__counted_and_dropped(self) -> None:
        ...
        from pmd_pytcp.tests.lib.network_testcase import STACK__MAC_ADDRESS
