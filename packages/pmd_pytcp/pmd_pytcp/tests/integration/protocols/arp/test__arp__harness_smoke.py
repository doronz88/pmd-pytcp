...
pmd_pytcp/tests/integration/protocols/arp/test__arp__harness_smoke.py
...
class TestArpHarnessSmoke(ArpTestCase):
    ...
    def test__arp__harness__monotonic_patch_visible_to_arp_cache_module(self) -> None:
        ...
        'pmd_pytcp.lib.neighbor' module's ARP-cache 'find_entry'
        ...
        from pmd_pytcp.lib import neighbor as neighbor_module
