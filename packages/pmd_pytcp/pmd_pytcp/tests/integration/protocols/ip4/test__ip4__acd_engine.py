...
pmd_pytcp/tests/integration/protocols/ip4/test__ip4__acd_engine.py
...
from pmd_pytcp.socket import ETH_P_ARP, SOCK_RAW, AddressFamily, socket
...
from pmd_pytcp.tests.lib.network_testcase import STACK__MAC_ADDRESS, NetworkTestCase
...
class TestIp4AcdEngine(NetworkTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.enterContext(patch("pmd_pytcp.protocols.ip4.acd.ip4_acd.random.uniform", return_value=0.0))
