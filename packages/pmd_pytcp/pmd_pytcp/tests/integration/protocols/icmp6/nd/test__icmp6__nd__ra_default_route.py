...
pmd_pytcp/tests/integration/protocols/icmp6/nd/test__icmp6__nd__ra_default_route.py
...
from pmd_pytcp.tests.lib.network_testcase import STACK__IP6_HOST, STACK__MAC_ADDRESS
