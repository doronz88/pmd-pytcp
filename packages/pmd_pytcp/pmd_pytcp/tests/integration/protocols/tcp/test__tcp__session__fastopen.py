...
pmd_pytcp/tests/integration/protocols/tcp/test__tcp__session__fastopen.py
...
class TestTcpSession__FastOpen(TcpTestCase):
    ...
    def test__fastopen__server_accepts_syn_data_with_valid_cookie(self) -> None:
        ...
        from pmd_pytcp import stack
        from pmd_pytcp.protocols.tcp.tcp__fastopen import generate_cookie
    ...
    def test__fastopen__cookie_cache_evicts_oldest_at_cap(self) -> None:
        ...
        # entries.
        self._start_patch("pmd_pytcp.stack.TCP__FASTOPEN_CACHE_MAX_SIZE", 3)
