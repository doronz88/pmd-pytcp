...
pmd_pytcp/tests/integration/protocols/tcp/test__tcp__session__keepalive.py
...
from pmd_pytcp.socket import SO_KEEPALIVE, SOL_SOCKET, AddressFamily
...
class TestTcpKeepalive(TcpTestCase):
    ...
    def _patch_keepalive_constants(self) -> None:
        ...
        self._start_patch(
            "pmd_pytcp.protocols.tcp.tcp__constants.TCP__KEEPALIVE__IDLE_TIME_MS",
            TEST__KEEPALIVE_IDLE_TIME_MS,
        )
        self._start_patch(
            "pmd_pytcp.protocols.tcp.tcp__constants.TCP__KEEPALIVE__PROBE_INTERVAL_MS",
            TEST__KEEPALIVE_PROBE_INTERVAL_MS,
        )
        self._start_patch(
            "pmd_pytcp.protocols.tcp.tcp__constants.TCP__KEEPALIVE__PROBE_MAX_COUNT",
