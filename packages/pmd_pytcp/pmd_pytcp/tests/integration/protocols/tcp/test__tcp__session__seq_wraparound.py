...
The fix is the deferred migration to 'pmd_pytcp.protocols.tcp.tcp__seq's modular
...
pmd_pytcp/tests/integration/protocols/tcp/test__tcp__session__seq_wraparound.py
...
# 32-bit modular constants. These mirror what 'pmd_pytcp.protocols.tcp.tcp__seq'
    ...
    def test__seq_wraparound__outbound_data_seq_wraps_modularly(self) -> None:
        ...
        try:
            ...
            self.fail(
                ...
                "'tcp__session.py' to use 'pmd_pytcp.protocols.tcp.tcp__seq's "
                "'add32' helper."
            )
    ...
    def test__seq_wraparound__inbound_ack_across_wrap_advances_snd_una(self) -> None:
        ...
        self.assertEqual(
            ...
            msg=(
                ...
                "'pmd_pytcp.protocols.tcp.tcp__seq'."
            ),
        )
