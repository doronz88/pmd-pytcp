...
pmd_pytcp/tests/integration/protocols/tcp/test__tcp__session__harness_smoke.py
...
class TestTcpTestCaseHarness(TcpTestCase):
    ...
    def test__harness__force_iss_patches_compute_iss(self) -> None:
        ...
        from pmd_pytcp.protocols.tcp.session.tcp__session import (  # type: ignore[attr-defined] # noqa: E501
