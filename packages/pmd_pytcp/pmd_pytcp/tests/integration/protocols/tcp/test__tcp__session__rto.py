...
pmd_pytcp/tests/integration/protocols/tcp/test__tcp__session__rto.py
...
from pmd_pytcp.protocols.tcp.tcp__rto import (
    INITIAL_RTO_MS,
    RtoState,
    initial_state,
    update,
...
class TestTcpRtoInitialization(TcpTestCase):
    ...
    def test__rto__fresh_session_initializes_rto_state_to_initial(self) -> None:
        ...
        self.assertIsInstance(
            session._rto_state,
            RtoState,
            msg=("'_rto_state' must be the typed 'RtoState' " "dataclass from 'pmd_pytcp.protocols.tcp.tcp__rto'."),
        )
...
class TestTcpRtoSynFloor(TcpTestCase):
    ...
    def _make_listen_session(self, *, iss: int) -> tuple[TcpSocket, TcpSession]:
        ...
        from pmd_net_addr import Ip4Address as _Ip4Address
    ...
    def test__rto__passive_open_with_syn_ack_retransmit_floors_rto_at_3000ms(self) -> None:
        ...
        # child socket id.
        from pmd_pytcp.socket import SocketType
