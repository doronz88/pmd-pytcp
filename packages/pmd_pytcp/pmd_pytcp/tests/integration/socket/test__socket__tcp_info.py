...
pmd_pytcp/tests/integration/socket/test__socket__tcp_info.py
...
from pmd_pytcp.socket import IPPROTO_TCP, TCP_INFO, AddressFamily
from pmd_pytcp.socket.tcp__info import (
    TCP_INFO__STRUCT,
    TcpInfoOption,
    TcpInfoState,
)
...
class TestTcpSocketGetsockoptTcpInfo(TcpTestCase):
    ...
    def test__tcp_info__fsm_state_map_covers_every_fsm_state(self) -> None:
        ...
        from pmd_pytcp.socket.tcp__info import _FSM_TO_TCP_INFO_STATE
