...
`from pmd_net_addr import …` exposes the concrete value types, the ABCs
...
lazily — `from pmd_net_addr import ClickTypeIp4Address` works but pulls in
...
- Addressing-RFC fidelity (RFC 4291 scopes, 5952 canonical text, 4007
  ...
  [`.claude/rules/pmd_net_addr.md`](https://github.com/ccie18643/PyTCP/blob/master/.claude/rules/pmd_net_addr.md).
