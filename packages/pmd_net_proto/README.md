...
(see [`.claude/rules/pmd_net_proto.md`](https://github.com/ccie18643/PyTCP/blob/master/.claude/rules/pmd_net_proto.md)):
...
- Per-RFC adherence records live in
  ...
  / assembler / options rows are pmd_net_proto's surface). The
