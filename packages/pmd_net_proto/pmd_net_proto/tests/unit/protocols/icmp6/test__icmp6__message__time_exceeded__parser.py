...
pmd_net_proto/tests/unit/protocols/icmp6/test__icmp6__message__time_exceeded__parser.py
...
class TestIcmp6MessageTimeExceededParser(TestCase):
    ...
    def test__icmp6__message__time_exceeded__parser__dispatches_to_time_exceeded(
        ...
        from pmd_net_proto.protocols.icmp6.icmp6__assembler import Icmp6Assembler  # noqa: PLC0415
