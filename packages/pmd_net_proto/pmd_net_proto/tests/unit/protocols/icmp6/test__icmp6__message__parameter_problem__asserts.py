...
pmd_net_proto/tests/unit/protocols/icmp6/test__icmp6__message__parameter_problem__asserts.py
...
from pmd_net_proto.protocols.ip6.ip6__header import IP6__HEADER__LEN, IP6__MIN_MTU
