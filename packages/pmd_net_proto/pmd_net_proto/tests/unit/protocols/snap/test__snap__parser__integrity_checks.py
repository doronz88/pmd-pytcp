...
pmd_net_proto/tests/unit/protocols/snap/test__snap__parser__integrity_checks.py
...
from pmd_net_proto import PacketRx, SnapIntegrityError, SnapOui, SnapParser
