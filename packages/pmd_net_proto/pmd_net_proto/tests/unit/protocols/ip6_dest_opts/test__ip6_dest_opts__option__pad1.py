...
"""
This module contains tests for the IPv6 Dest Opts Pad1 option.

pmd_net_proto/tests/unit/protocols/ip6_dest_opts/test__ip6_dest_opts__option__pad1.py
...
class TestIp6DestOptsOptionPad1(TestCase):
    """
    The IPv6 Dest Opts Pad1 option tests.
    """

    def test__ip6_dest_opts__option__pad1__len(self) -> None:
        """
        ...
        self.assertEqual(
            len(opt),
            1,
            msg="IP6_DEST_OPTS__OPTION__PAD1__LEN must equal 1.",
        )

    def test__ip6_dest_opts__option__pad1__bytes(self) -> None:
        """
    ...
    def test__ip6_dest_opts__option__pad1__type(self) -> None:
        """
        Ensure the Pad1 option's 'type' field is the canonical
        Ip6DestOptsOptionType.PAD1 enum member, not a synthesised
        unknown.
        ...
        self.assertIs(
            opt.type,
            Ip6DestOptsOptionType.PAD1,
            msg="Pad1 option type must be Ip6DestOptsOptionType.PAD1.",
        )

    def test__ip6_dest_opts__option__pad1__str(self) -> None:
        """
    ...
    def test__ip6_dest_opts__option__pad1__from_buffer_roundtrip(self) -> None:
        """
        ...
        opt = Ip6DestOptsOptionPad1.from_buffer(b"\x00")
        self.assertEqual(
            opt,
            Ip6DestOptsOptionPad1(),
            msg="from_buffer(b'\\x00') must round-trip to Ip6DestOptsOptionPad1().",
        )
        self.assertEqual(
            bytes(opt),
            b"\x00",
    ...
    def test__ip6_dest_opts__option__pad1__from_buffer_rejects_wrong_type(self) -> None:
        """
        ...
        with self.assertRaises(AssertionError):
            Ip6DestOptsOptionPad1.from_buffer(b"\x01")
