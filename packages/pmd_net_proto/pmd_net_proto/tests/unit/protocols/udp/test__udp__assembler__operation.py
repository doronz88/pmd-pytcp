...
pmd_net_proto/tests/unit/protocols/udp/test__udp__assembler__operation.py
...
from pmd_net_proto import UDP__HEADER__LEN, Tracker, UdpAssembler, UdpHeader
...
class TestUdpAssemblerMisc(TestCase):
    ...
    def test__udp__assembler__assemble__zero_compute_substituted_with_all_ones(self) -> None:
        ...
        with patch(
            "pmd_net_proto.protocols.udp.udp__assembler.inet_cksum",
            return_value=0,
        ):
    ...
    def test__udp__base__bytes__zero_compute_substituted_with_all_ones(self) -> None:
        ...
        with patch(
            "pmd_net_proto.protocols.udp.udp__base.inet_cksum",
            return_value=0,
        ):
