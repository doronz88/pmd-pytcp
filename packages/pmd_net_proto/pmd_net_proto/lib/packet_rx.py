...
if TYPE_CHECKING:
    ...
    from pmd_net_proto.protocols.ip6_dest_opts.ip6_dest_opts__parser import (
        Ip6DestOptsParser,
    )
    from pmd_net_proto.protocols.ip6_frag.ip6_frag__parser import Ip6FragParser
    from pmd_net_proto.protocols.ip6_hbh.ip6_hbh__parser import Ip6HbhParser
    from pmd_net_proto.protocols.ip6_routing.ip6_routing__parser import (
        Ip6RoutingParser,
    )
